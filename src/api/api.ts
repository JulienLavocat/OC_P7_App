...
export const AuthenticationApiFactory = function (
	...
	return {
		...
		refreshToken(
			...
			return localVarFp
				.refreshToken(refreshTokenResponse, options)
				.then((request) => request(axios, basePath));
		},
		/**
		 *
...
export const PostsApiAxiosParamCreator = function (
	...
	return {
		...
		dislike: async (
			...
			const localVarPath = `/posts/{postId}/dislike`.replace(
				`{${"postId"}}`,
		...
		like: async (
			...
			const localVarPath = `/posts/{postId}/like`.replace(
				`{${"postId"}}`,
				encodeURIComponent(String(postId))
			);
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const PostsApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async dislike(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.dislike(
				postId,
				options
			);
			return createRequestFunction(
		...
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.getFeed(
				options
			);
			return createRequestFunction(
				localVarAxiosArgs,
		...
		async like(
			...
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
		> {
			const localVarAxiosArgs = await localVarAxiosParamCreator.like(
				postId,
				options
			);
			return createRequestFunction(
